...
xloadcols(void)
{
	...
	xloadcolor(defaultfg, colorname[defaultfg], &dc.col[defaultfg]);
	xloadcolor(defaultbg, colorname[defaultbg], &dc.col[defaultbg]);
	xloadcolor(defaultrcs, colorname[defaultrcs], &dc.col[defaultrcs]);
